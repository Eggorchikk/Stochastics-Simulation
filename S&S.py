...
#     param_times = []
#     for _ in range(n_sims):
#         t_reach = simulate_until_goal(lam_income, income_dist, lam_expense, expense_dist, goal)
...
#     plt.axvline(goal, color='black', linestyle='--', label=f"Reference Goal (€{goal})")
